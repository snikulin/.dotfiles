...
nnoremap <C-x>h <cmd>lua require('telescope.builtin').help_tags()<cr>
...
local servers = { "graphql", "tsserver", "vimls", "vuels", "diagnosticls", "solargraph" }
...
dap.adapters.node2 = {
  type = 'executable',
  command = 'node',
  args = {os.getenv('HOME') .. '/pro/_github/vscode-node-debug2/out/src/nodeDebug.js'},
}
...
dap.adapters.chrome = {
    type = "executable",
    command = "node",
    args = {os.getenv("HOME") .. "/pro/_github/vscode-chrome-debug/out/src/chromeDebug.js"} -- TODO adjust
}
